...
public class ReflectionRefractionTests {
	...
	public void twoSpheresOnMirrors() {
		...
		scene.geometries.add( //
				...
				new Triangle(new Point(1500, -1500, -1500), new Point(-1500, 1500, -1500), new Point(670, 670, 3000)) //
						...
						.setMaterial(new Material().setKr(new Double3(0.1))),
	...
	@Test
	public void myTest(){
		Point x = new Point(new Double3(-4.429144957359225E-13,-1.988955817505082E-13,9.004499594585744E-13));
		boolean y = x.equals(Double3.ZERO);;
		double z = Util.alignZero(1.0230067607116913E-12);;
		boolean u = Util.isZero(x.getX());
		int a = 1;
	}
}
